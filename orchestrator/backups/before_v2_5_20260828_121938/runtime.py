...
# ================================================================
# PROJECT-1 v2.4 CONTRACT METHODS
# ================================================================

def _project1_v24_build_planner_prompt(
    self,
    task,
...
def _project1_v24_normalize_planner_response(
    self,
    raw,
):
...
def _project1_v24_zero_model_prompt(
    self,
    task,
    history=None,
):
    ...
    return self.build_v24_planner_prompt(
        task,
        [],
        history,
    )
...
def _project1_v24_has_executable_models(
    self,
):
...
# Bind methods to the actual runtime class.
OrchestratorRuntime.build_v24_planner_prompt = (
    _project1_v24_build_planner_prompt
)

OrchestratorRuntime.normalize_v24_planner_response = (
    _project1_v24_normalize_planner_response
)

OrchestratorRuntime.build_v24_zero_model_prompt = (
    _project1_v24_zero_model_prompt
)

OrchestratorRuntime.has_executable_models = (
    _project1_v24_has_executable_models
)
